...
package body Scripted_Testing.Stubs.Scripting is
   ...
   package body Check_Number_Of_Calls is
      ...
      overriding procedure Execute (A : Check_Action)
      is
      begin
         declare
   ...
   package body Save_Number_Of_Calls is
      ...
      overriding procedure Execute (A : Save_Action)
      is
      begin
   ...
   package body Set_Returned_Value is
      ...
      overriding procedure Execute (A : Returned_Action)
      is
      begin
         declare
            procedure Set_Returned_Type
              is new Scripted_Testing.Stubs.Set_Output_Value (Returned_Type);
            Subprogram : constant String := +A.Subprogram;
      ...
      begin
         declare
            function Get_Checked_Type
              is new Scripted_Testing.Stubs.Get_Input_Value (Checked_Type);
            Subprogram : constant String := +A.Subprogram;
            Parameter : constant String := +A.Parameter;
   ...
   package body Check_Keyed_Value is
      ...
      begin
         declare
            function Get_Checked_Type
              is new Scripted_Testing.Stubs.Get_Keyed_Input_Value
